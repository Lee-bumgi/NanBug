...
const resizeLetters = () => {
  ...
  textCenter = textRect.top + textRect.height;
  positionLetters();
};
...
let test_fun = function (e) {
  ...
  //  else {
  //   temp_str = e.key;
  //   input.value = input.value + temp_str
  //   console.log("입력")
  //   temp_str = "";
  //   input.click();
  // }
...
let del_text = function () {
  if (offscreenText.childNodes.length > 6) {
    offscreenText.firstChild.remove()
...
input.addEventListener("click", del_text);
